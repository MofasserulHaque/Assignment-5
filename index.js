...
const displayMainBars=(data)=>{
 const mainbarsUpload=document.getElementById("main-button-container");
...
data.forEach(element => {
  ...
  <div class="flex justify-between"><img class="h-min" src="./assets/Open-Status.png" alt=""><button id="high" class="btn bg-[#ffd2d2]  text-[#d71313] text-[15px] rounded-full p-5">${element.priority}</button></div>
  ...
  <p class="text-[#64748B]">1/5/2024</p>
</div>
    `
